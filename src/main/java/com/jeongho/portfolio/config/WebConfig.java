...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginCheckInterceptor())
                .order(1)
                .addPathPatterns("/**")
                .excludePathPatterns("/","/api/**", "/practice", "/member/new", "/member/login", "/board/list", "/board/dtl/**", "/css/**", "/static/css/layout1.css", "/*.css", "/templates/layouts/layout1.html", "/*.ico", "/resources/**","/comment/update");
