...
//                        "/*.css", "/templates/layouts/layout.html", "/*.ico", "/resources/**","/comment/update","/error","/static/**");
//
//        registry.addInterceptor(new MemberInfoInterceptor())
//                .order(2)
//                .addPathPatterns("/**")
//                .excludePathPatterns("/*.css","/api/**", "/*.ico", "/css/layout1.css","/comment/update","/error", "/static/**");
//    }
//}
//
//
